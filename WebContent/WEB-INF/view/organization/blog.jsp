		...
		<div class="container">
				...
				<c:if test="${R==0}">
					<c:forEach items="${rep_List.response.body.items.item}" var="item"
                       ...
                       <c:when test="${item.stored_file_name==null}">
                            ...
                            <a href="board.do?nanmmbyId=${item.nanmmbyId}"
									class="block-20 rounded"
									style="background-image: url('http://220.121.119.5:8080/GibunigajoaSample/resources/images/${item.stored_file_name}');">
								</a>
                            </c:otherwise>
			...
			<c:if test="${R==1}">
                       ...
                       <c:when test="${banner==null}">
                            ...
                            <a href="board.do?nanmmbyId=${rep.response.body.items.item.nanmmbyId}"
									class="block-20 rounded" 
									style="background-image: url('http://220.121.119.5:8080/GibunigajoaSample/resources/images/${banner}');">
								</a>
                            </c:otherwise>
